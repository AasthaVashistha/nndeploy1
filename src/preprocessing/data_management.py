...
def save_model(theta0, theta, file_name="two_input_xor_nn.pkl"):
    ...
    print(f"Saved model with file name {file_name} at {config.SAVED_MODEL_PATH}")

def load_model(file_name="two_input_xor_nn.pkl"):
    pkl_file_path = os.path.join(config.SAVED_MODEL_PATH, file_name)
